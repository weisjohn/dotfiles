...
The command to get everything started is [~/bin/dotfiles][dotfiles], and this is my "dotfiles" Git repo.
...
* Files in `bin` are executable shell scripts ([~/mysrc/dotfiles/bin][bin] is added into the path).
